  ...
  <div class="relative min-h-screen text-white">
    <main class="mx-auto max-w-screen-xl space-y-6 px-4 pb-10 pt-8 md:px-6">
      <header class="glass flex items-center justify-between px-4 py-3">
        ...
        <RouterLink class="rounded-xl border border-white/15 bg-white/5 px-3 py-2 text-xs text-white/75 hover:bg-white/[0.09]" to="/">
          Back
        </RouterLink>
      </header>
      ...
      <div v-if="isLoading" class="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
        <div v-for="i in 12" :key="i" class="rounded-[1.45rem] border border-white/10 bg-white/[0.05] motion-pulse-soft">
